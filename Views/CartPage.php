                ...
                <tbody>
                  ...
                  ";
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <img
                                src="https://template.hasthemes.com/koparion/koparion/img/banner/8.jpg" />
                        </td>
                        <td>Harry potter Lorem ipsum dolor sit amet consectetur
                            adipisicing elit. Quas, eaque aliquid, harum, facere
                            odio repellendus ex totam et enim exercitationem ab.
                            A voluptatum voluptates culpa cumque. Quidem,
                            voluptate impedit! Sint!</td>
                        <td>£165113113131.00</td>
                        <td>
                            <input type="number" placeholder="0" min="1"
                                max="10" step="1"
                                onkeypress="return event.charCode >= 48"
                                value="100" class="quantityInput">
                        </td>
                        <td>100</td>
                        <td>
                            <i class="far fa-trash-alt fa-3x deleteIcon"></i>
                ...
                <div class="col-lg-8 col-md-12 col-12 p-0">
                    <div class="d-flex flex-column">
                        <div class="btnWrapper">
                            ...
                            <button class="blackButton">Continue
                                shopping</button>
                        </div>
