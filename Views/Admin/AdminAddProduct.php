<div id=<?php echo $ADD_PRODUCT ?>
    class="<?php echo $tab == "" || $tab == $ADD_PRODUCT ? "active" : "" ?>">
    <h3>Add product</h3>
        ...
        <form id="addBookForm">
            <div class="mt-1 w-100 form-group">
                ...
                <input type="text" class="baseInput"
                    placeholder="Enter book name..." id="newBookName">
            </div>
            <div class="mt-1 w-100 form-group">
                <label for="newBookQuantity">Book quantity</label>
                <input type="number" id="newBookQuantity" class="baseInput"
                    placeholder="Book quantity..." min="1" step="1"
                    onkeypress="return event.charCode >= 48">
            </div>
            <div class="mt-1 w-100 form-group">
                <label for="newBookPrice">Book price</label>
                <input type="number" id="newBookPrice" class="baseInput"
                    placeholder="Book price..." min="1" step="1"
                    onkeypress="return event.charCode >= 48">
            </div>
            <div class="mt-1 w-100 form-group">
            ...
            <div class="mt-1 w-100 form-group">
                ...
                <input type="file" accept="image/*" id="newBookImage"
                    multiple />

            </div>
            <div class="w-100 text-center">
                <button type="button" id="addNewProduct"
                    value='<?php echo $ADD_NEW_PRODUCT ?>'
                    class="submitButton">Submit btn</button>
