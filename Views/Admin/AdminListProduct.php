        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button value='<?php echo $EDIT_PRODUCT ?>' type="submit"
    ...
    $('#table').DataTable({
        ...
        columns: [{
                "render": function(data, type,
                    JsonResultRow) {
                    return '<img style="width: 100px; height: 150px;" src="' +
                        JsonResultRow.bookImageUrl +
                        '">';
                }
            },
            {
            ...
            },
            {
                "render": function(data, type,
                    JsonResultRow) {
                    return `<a href="#" class="edit" data-idBook="${JsonResultRow.id_book}" data-toggle="modal" data-target="#exampleModal">Edit</a>&nbsp<a href="#" id="delete" data-idBook="${JsonResultRow.id_book}">Delete</a>`;
                }
            },
        ],
        "pageLength": 4
