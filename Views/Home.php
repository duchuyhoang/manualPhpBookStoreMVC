...
<body>
  ...
  <?php require dirname(__FILE__) . "/../shared/" . 'actionsType.php' ?> -->
        ...
        <div class="service col-3">
            <div class="service-icon d-flex align-items-center ">
                ...
                <div class="d-flex flex-column ml-2">
                    ...
                    <div class="serviceDescription">For all orders over $500
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="service col-3">
            <div class="service-icon d-flex align-items-center ">
                ...
                <div class="d-flex flex-column ml-2">
                    ...
                    <div class="serviceDescription">Lorem ipsum dolor consecte
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="top" class="">
        ...
        <p class="subHeader text-center">Browse the collection of our best
            selling and top interresting products.
                    ...
                    <div class="col-12 position-relative">
                        ...
                        <div class="border-box">
                            <a href="" class="d-block  overflow-hidden">
                                ...
                                <p class="position-absolute banner-text">
                                    G.Meyner book & Spiritual Traveler Press</p>
                                <p class="position-absolute banner-text-2">Sale
                                    up to 30% off</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="authorInfomation mt-2">
                                ...
                                <div class="authorCategory">CATEGORIES:BOOKS ,
                                    AUDIOBOOKS</div>

                                <div class="authorDescription">
                                    Vestibulum porttitor iaculis gravida.
                                    Praesent vestibulum varius placerat. Cras
                                    tempor congue neque, id aliquam orci finibus
                                    sit amet. Fusce at facilisis arcu. Donec
                                    aliquet nulla id turpis semper, a bibendum
                                    metus vulputate. Suspendisse potenti.
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="bookCategoryItemWrapper">
                                    ...
                                    <div class="bookCategoryItemPrice d-flex">
                                        <div class="currentPrice ml-1">$30.00
                                        </div>
            ...
            <div class="col-lg-2 col-md-12 col-sm-12">
                <form class="blockLetter">
                    ...
                    <p style="color:#fff">You can be always up to date with our
                        company new!</p>
